...
<div class="p-6 space-y-4">
    ...
    <div class="flex items-center space-x-4">
        <x-bladewind::input type="text" wire:model.live.debounce.500ms="search" placeholder="Search donations..."
            class="border h-full" />
            ...
            <tbody>
                @foreach ($donations as $donation)
                    <tr>
                        ...
                        <td>
                            <select wire:change="updateDonationStatus({{ $donation->id }}, $event.target.value)"
                        ...
                        <td class="shrink-0">
                            <x-bladewind::button wire:click="redirectToEdit({{ $donation->id }})" size="small"
                                color="primary" icon="pencil-square">
                                Edit
                            </x-bladewind::button>
                            <x-bladewind::button wire:click="deleteDonation({{ $donation->id }})"
