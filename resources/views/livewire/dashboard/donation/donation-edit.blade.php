<main class="p-4">
    <form wire:submit.prevent="update" id="donationEditForm">
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            @if ($existingTransferEvidence)
            <div class="mt-2">
                <img src="{{ asset($existingTransferEvidence) }}" alt="Existing Evidence" class="w-32 h-32 object-cover">
            </div>
            @endif

            @if ($transfer_evidence)
            <div class="mt-2">
                <img src="{{ $transfer_evidence->temporaryUrl() }}" alt="New Evidence Preview" class="w-32 h-32 object-cover">
            </div>
            @endif
        </div>
