    ...
    <x-bladewind::table has_shadow="true" divider="thin">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="shrink-0">
                    <x-bladewind::button wire:click="redirectToEdit({{ $category->id }})" size="small" color="primary" icon="pencil-square">
                        Edit
                    </x-bladewind::button>
                    <x-bladewind::button wire:click="deleteCategory({{ $category->id }})" wire:confirm="Are you sure to delete this?" size="small" color="red" icon="trash">
                        Delete
                    </x-bladewind::button>
                </td>
            </tr>
