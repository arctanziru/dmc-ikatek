            ...
            <x-bladewind::table has_shadow="true" divider="thin">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($category->image)
                            <img src="{{ asset('storage/' . $category->image) }}" alt="Image" class="w-20 h-20 object-cover rounded-md">
                            @else
                            <span>No Image</span>
                            @endif
                        </td>
                        <td>
                            ...
                            <img src="{{ asset('storage/' . $category->cover_image) }}" alt="Cover Image" class="w-20 h-20 object-cover rounded-md">
                            @else
                            <span>No Cover Image</span>
                            @endif
                        </td>
                        <td>
                            Edit to see image galleries
                        </td>
                        <td class="shrink-0">
