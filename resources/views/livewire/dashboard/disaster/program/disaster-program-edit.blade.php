<main class="p-4">
    <form wire:submit.prevent="update" id="programEditForm">
        ...
        <div class="mb-4">
            ...
            @if ($existingImage)
            <div class="mt-2">
                <img src="{{ asset($existingImage) }}" alt="Existing Image" class="w-32 h-32 object-cover">
            </div>
            @endif

            @if ($image)
            <div class="mt-2">
                <img src="{{ $image->temporaryUrl() }}" alt="New Image Preview" class="w-32 h-32 object-cover">
            </div>
            @endif
        </div>
